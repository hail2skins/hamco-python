...
class TemplateTest(TestCase):
    ...
    # Test the history page contains the title and company from the common_context context processor
    def test_history_contains_title_and_company(self):
        response = self.client.get('/notes/history')
        self.assertContains(response, '<title>Hamco Internet Solutions</title>', html=True)
        self.assertContains(response, '<a class="navbar-brand" href="index.html">Hamco Internet Solutions</a>', html=True)
